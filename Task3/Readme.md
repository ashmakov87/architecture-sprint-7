...
Диаграмма контекста представлена в файле **Containers.puml**

# **Диаграмма контейнеров**

Обновленная диаграмма контейнеров представлена в файле **Containers.drawio.xml**

# **Требования к внешним интеграциям**

Внешние интеграции PropDevelopment должны соответствовать следующим требованиям.

## **1. Требования к безопасности**
- Передача данных между системами должна осуществляться с использованием **TLS 1.2/1.3**.
...
- API-интеграции должны использовать **OAuth 2.0/OpenID Connect** для аутентификации.
...
- Взаимодействие между системами должно быть **событийно-ориентированным (Event-driven)** с возможностью публикации/подписки для обновления данных в реальном времени.
